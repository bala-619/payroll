...
class ReportDataTable2 extends StatefulWidget {
  ...
  ReportDataTable2({this.gridDataRowList,this.gridData,this.selectedIndex,this.voidCallback,this.func,required this.topMargin,required this.gridBodyReduceHeight});
  @override
